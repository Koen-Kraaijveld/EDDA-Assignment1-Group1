...
print(t.test(diet_1_preweight, diet_1_weight6weeks, paired=TRUE, alternative="g"))
print(t.test(diet_2_preweight, diet_2_weight6weeks, paired=TRUE, alternative="g"))
print(t.test(diet_3_preweight, diet_3_weight6weeks, paired=TRUE, alternative="g"))
